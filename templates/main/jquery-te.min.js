...
(function($){		
	$.fn.jqte = function(options){
		...
		var linktypes = ["Web Address","E-mail Address"];
			...
			for(var n = 0; n < buttons.length; n++)
			{
				...
				if(vars[buttons[n].name])
				{
					...
					else if(buttons[n].name=="fsize" && $.isArray(vars.fsizes))
					{
						...
						{
							toolbar.find("."+vars.css+"_fontsizes").append('<a '+vars.css+'-styleval="'+ vars.fsizes[f] +'" class="'+vars.css+'_fontsize'+'" style="font-size:'+ vars.fsizes[f]  + vars.funit+'" role="menuitem" unselectable>Comis...</a>');
						}
					}
